...
const DEFS: Def[] = [
  ...
  { key: 'terminal_knee_ext', name_zh: '终末伸膝 (TKE)', name_en: 'Terminal knee extension', measure_type: 'reps_only', body_parts: ['legs'], is_rehab: true, default_per_side: true, rehab_purpose_zh: '强化股内侧肌、稳定髌骨', rehab_purpose_en: 'Strengthens VMO, stabilizes the patella', rehab_cues_zh: '弹力带套膝后，缓慢完全伸直，顶峰收缩 2 秒', rehab_cues_en: 'Band behind the knee; extend fully and hold 2s', rehab_dosage: '3×15 / 每日' },
  { key: 'spanish_squat', name_zh: '西班牙深蹲', name_en: 'Spanish squat', measure_type: 'duration', body_parts: ['legs'], is_rehab: true, rehab_purpose_zh: '髌腱等长负荷、减痛', rehab_purpose_en: 'Isometric patellar-tendon loading, analgesic', rehab_cues_zh: '弹力带固定膝后，后坐至 60° 保持', rehab_cues_en: 'Band behind knees; sit back to ~60° and hold', rehab_dosage: '5×45s / 隔日' },
  { key: 'ankle_alphabet', name_zh: '踝关节字母操', name_en: 'Ankle alphabet', measure_type: 'reps_only', body_parts: ['legs'], is_rehab: true, default_per_side: true, rehab_purpose_zh: '恢复踝关节活动度', rehab_purpose_en: 'Restores ankle range of motion', rehab_cues_zh: '用脚尖在空中书写 A–Z，全程无痛', rehab_cues_en: 'Trace A–Z with the toes, pain-free', rehab_dosage: '2 组 / 每日' },
  { key: 'calf_raise_rehab', name_zh: '单腿提踵 (康复)', name_en: 'Single-leg calf raise (rehab)', measure_type: 'reps_only', body_parts: ['legs'], is_rehab: true, default_per_side: true, rehab_purpose_zh: '重建跟腱/小腿负荷耐受', rehab_purpose_en: 'Rebuilds calf/Achilles load tolerance', rehab_cues_zh: '扶墙单腿缓起缓落，3 秒离心', rehab_cues_en: 'Slow 3s eccentric, hold the wall for balance', rehab_dosage: '3×12 / 隔日' },
  { key: 'scap_pushup', name_zh: '肩胛俯卧撑', name_en: 'Scapular push-up', measure_type: 'reps_only', body_parts: ['shoulders'], is_rehab: true, bodyweight: true, rehab_purpose_zh: '前锯肌激活、肩胛稳定', rehab_purpose_en: 'Serratus activation, scapular control', rehab_cues_zh: '肘不弯，只做肩胛前伸/后缩', rehab_cues_en: 'Keep elbows straight; protract/retract only', rehab_dosage: '3×12 / 每日' },
  { key: 'bird_dog', name_zh: '鸟狗式', name_en: 'Bird-dog', measure_type: 'reps_only', body_parts: ['core'], is_rehab: true, default_per_side: true, rehab_purpose_zh: '腰椎抗旋稳定', rehab_purpose_en: 'Anti-rotation lumbar stability', rehab_cues_zh: '对侧手脚伸展，骨盆不晃', rehab_cues_en: 'Extend opposite arm/leg; keep hips level', rehab_dosage: '3×10 / 每日' },
]
